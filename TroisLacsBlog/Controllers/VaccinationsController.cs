...
using TroisLacsBlog.Models;

namespace TroisLacsBlog.Controllers
{
    public class VaccinationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,brand")] Vaccination vaccination)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,brand")] Vaccination vaccination)
        {
            if (ModelState.IsValid)
            {
